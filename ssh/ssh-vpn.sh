...
echo "Checking VPS"
IZIN=$(curl https://raw.githubusercontent.com/PixerJason/project/main/ipvps.txt | grep $MYIP | awk '{print $3}')
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Telegram : https://t.me/PixerJason"
exit 0
fi
clear
# ==================================================
...
akbarvpnn="raw.githubusercontent.com/PixerJason/cfnfree/main/xray"

# Link Hosting Kalian Untuk Trojan Go
akbarvpnnn="raw.githubusercontent.com/PixerJason/cfnfree/main/trojango"

# Link Hosting Kalian Untuk Stunnel5
akbarvpnnnn="raw.githubusercontent.com/PixerJason/cfnfree/main/stunnel5"

#Link Hosting Kalian Untuk Websocket
akbarvpnnnnn="raw.githubusercontent.com/PixerJason/cfnfree/main/websocket"
